...
(define-macro (get32 lo hi u8vect i body)
  `(let* ((index
           ,i)
          (,lo
           (u16 (u8vector-ref ,u8vect (+ index 3))
                (u8vector-ref ,u8vect (+ index 2))))
          (,hi
           (u16 (u8vector-ref ,u8vect (+ index 1))
...
(define RSb
  '#u8(#x52 #x09 #x6A #xD5 #x30 #x36 #xA5 #x38
...
(define-type aes-context
  id: aes-context-5e6282ec-d8bb-48ef-8fba-9c48cfe1b44c
